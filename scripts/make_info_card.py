...
# Default to a static SVG so it renders reliably in README previews and
# simple image viewers. Set STATIC=0 to opt back into the animated version.
STATIC_ENV = os.environ.get("STATIC", "1").strip().lower()
STATIC = STATIC_ENV not in {"", "0", "false", "no", "off"}
...
ROWS = [
    ("host",),
    ("kv", "From", "Surat, Gujarat"),
    ("kv", "LinkedIn", "kunj-thummar-ba6516326"),
    ("kv", "Instagram", "@kunj_thummar_"),
    ("gap",),
    ("sec", "Skills"),
    ("bul", "C/C++, Java, HTML, CSS, JS"),
    ("bul", "React.js, Node.js, Express.js"),
    ("bul", "MongoDB, PostgreSQL, Firebase"),
    ("bul", "Postman, Vercel, Render, Supabase"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Student at CHARUSAT - CE"),
    ("bul", "3rd Runner-Up, DataQuest Coding Hackathon"),
    ("bul", "Campus Mentor · ERP Portal · Carbon Footprint AI"),
]
...
parts.append(f'<text x="{W/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
             f'text-anchor="middle">kunj@github: ~$ neofetch</text>')
